...
- Name: web\specs\login.spec.ts >> Login Page Tests >> Negative Tests >> should show error for both invalid credentials
- Location: tests\web\specs\login.spec.ts:74:9
